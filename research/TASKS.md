...
| A2a| Identify correct primary substation for downtown Norfolk core | NEEDS REDO | [2026-03-16-A2a-downtown-substation-id.md](findings/2026-03-16-A2a-downtown-substation-id.md) — REJECTED (see claude-review). **Do not derive substation names from street names.** Correct approach: search Norfolk GIS (air.norfolk.gov) for parcels owned by "Virginia Electric and Power" in zip codes 23510 and 23517. Cross-reference against Dominion hosting capacity map (dominionenergy.com/hosting-capacity). |
